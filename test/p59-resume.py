...
resume = driver.find_element_by_xpath('/html/body/app-root/main/app-choose-pitchcard-page/div/div/app-choose-pitchcard/div/div/div[2]/div[2]/div[3]/button')
resume.click()
time.sleep(5)
...
# driver.find_element_by_xpath('//*[@id="main-form"]/div/app-employment/form/div/div[1]/div[1]/p-multiselect/div').click()
# driver.find_element_by_xpath('//*[@id="main-form"]/div/app-employment/form/div/div[1]/div[1]/p-multiselect/div/div[4]/div/ul/p-multiselectitem[1]/li').click()

# driver.find_element_by_xpath('//*[@id="main-form"]/div/app-employment/form/div/div[1]/div[2]/p-dropdown/div').click()
# driver.find_element_by_xpath('//*[@id="main-form"]/div/app-employment/form/div/div[1]/div[2]/p-dropdown/div/div[4]/div/ul/p-dropdownitem[7]/li').click()

# driver.find_element_by_xpath('//*[@id="main-form"]/div/app-employment/form/div/span[2]/p-autocomplete/span/ul/li/input').send_keys('BYUI')
time.sleep(2)
...
driver.find_element_by_xpath('//*[@id="main-form"]/div/app-images/div/div[1]/div[1]/button/app-image-uploader/input').send_keys('../images/BYUI.png')
time.sleep(3)

driver.find_element_by_xpath('/html/body/div[4]/div/div[3]/p-footer/div').click()
time.sleep(3)
print('upload cover image')

driver.find_element_by_xpath('//*[@id="main-form"]/div/app-images/div/div[1]/div[3]/button/input').send_keys('WeiChunTang resume.pdf')
time.sleep(3)
print('upload resume')

driver.find_element_by_xpath('//*[@id="main-form"]/div/app-images/div/div[2]/div[1]/button/input').send_keys('BYUI.png')
time.sleep(3)
