...
# nextBtn = driver.find_element(By.XPATH,'/html/body/app-root/main/app-new-cards-packges/div/div/div/div[3]/div/button')
# nextBtn.click()
# time.sleep(2)
...
# freeTwo = driver.find_element(By.XPATH,'/html/body/app-root/main/app-billing-page/div/div/div/div/div[2]/app-visual-video/div/div[1]/div[2]/div[1]/div/div[2]')
# freeTwo.click()
# time.sleep(2)
...
driver.find_element(By.XPATH,'//*[@id="yourName"]').send_keys('Test')
