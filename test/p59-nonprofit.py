...
nonprofit = driver.find_element_by_xpath('/html/body/app-root/main/app-choose-pitchcard-page/div/div/app-choose-pitchcard/div/div/div[2]/div[1]/div[3]/button')
nonprofit.click()
time.sleep(2)
...
driver.find_element_by_xpath('/html/body/div[1]/div/div[2]/div/div[2]/app-payment-method-forms/div/div/div[2]/div/button').click()
time.sleep(5)
...
# ------------------------- upload image page ----------------------------
time.sleep(2)
driver.find_element_by_xpath('//*[@id="main-form"]/div/app-images/div/div[1]/div[1]/button/app-image-uploader/input').send_keys('logo.png')
time.sleep(4)
...
driver.find_element_by_xpath('//*[@id="main-form"]/div/app-images/div/div[1]/div[3]/button/app-image-uploader/input').send_keys('logo.png')
time.sleep(4)
